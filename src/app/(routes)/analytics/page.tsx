    ...
    <div className='p-20'>
        ...
        <div className="flex space-x-4">
            <div className="p-4 bg-white rounded-lg border shadow-sm">
                ...
                {totalTVL && 
                    <div className="font-bold text-lg">{parseFloat(totalTVL.toFixed(2))}</div>
                }
            </div>
            <div className="p-4 bg-white rounded-lg border shadow-sm">
                <div className="text-gray-600">Total Operators</div>
                <div className="font-bold text-lg">{totalOperators}</div>
            </div>
            <div className="p-4 bg-white rounded-lg border shadow-sm">
                <div className="text-gray-600">Total AVSs</div>
                <div className="font-bold text-lg">{totalAVSs}</div>
            </div>
            <div className="p-4 bg-white rounded-lg border shadow-sm">
                <div className="text-gray-600">Total Stakers</div>
                <div className="font-bold text-lg">{totalStakers}</div>
            </div>
            <div className="p-4 bg-white rounded-lg border shadow-sm">
                <div className="text-gray-600">TVL Restaking(ETH)</div>
                {totalRestaking && 
                    <div className="font-bold text-lg">{parseFloat(totalRestaking.toFixed(2))}</div>
                }
            </div>
        </div>
        ...
        <div>
          <div className="container mx-auto py-8">
            <h1 className='mt-10 mb-10'>Withdrawals</h1>
              ...
              <tbody>
                {withdrawals.map((withdrawal, index) => (
                  <tr key={index} className="even:bg-gray-100">
                    <td className="py-2 px-4 border">{withdrawal.createdAtBlock}</td>
                    <td className="py-2 px-4 border">{withdrawal.stakerAddress}</td>
                    <td className="py-2 px-4 border">{withdrawal.isCompleted ? 'Yes' : 'No'}</td>
                    <td className="py-2 px-4 border">{withdrawal.delegatedTo}</td>
